    ...
    <div class="card card-info">
      <div class="card-header">
        ...
        <div class="card-tools">
          <a href="kategori-blog" class="btn btn-sm btn-warning float-right"><i class="fas fa-arrow-alt-circle-left"></i> Kembali</a>
        </div>
      </div>
      <!-- /.card-header -->
      <!-- form start -->
...
<?php }?>
      ...
      <form class="form-horizontal" method="post" action="konfirmasi-edit-kategori-blog"> 
        <div class="card-body">
