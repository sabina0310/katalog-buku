                  ...
                  <?php 
                    ...
                    <td><?php echo $posisi+1;?></td>
                      ...
                      <a href="edit-penerbit-data-<?php echo $id_penerbit;?>" class="btn btn-xs btn-info"><i class="fas fa-edit"></i> Edit</a>
                        <a href="javascript:if(confirm('Anda yakin ingin menghapus data <?php echo $penerbit; ?>?'))window.location.href='penerbit-mode-hapus-data-<?php echo $id_penerbit;?>_notif-hapusberhasil'" 
...
if($jum_halaman==0){
   ...
   $setelah = $halaman+1;
   if($halaman!=1){
     echo "<li class='page-item'><a class='page-link' href='penerbit-halaman-1'>First</a></li>";
     echo "<li class='page-item'><a class='page-link' href='penerbit-halaman-$sebelum'>«</a></li>";
  }
  for($i=1; $i<=$jum_halaman; $i++){
      if ($i > $halaman - 5 and $i < $halaman + 5 ) {
         if($i!=$halaman){
             echo "<li class='page-item'><a class='page-link'href='penerbit-halaman-$i'>$i</a></li>";
         }else{
   ...
   if($halaman!=$jum_halaman){
        echo "<li class='page-item'><a class='page-link' href='penerbit-halaman-$setelah'>»</a></li>";
        echo "<li class='page-item'><a class='page-link' href='penerbit-halaman-$jum_halaman'>Last</a></li>";
   }
