                  ...
                  <?php 
                    ...
                    <tr>
                      ...
                      <td align="center">
                        ...
                        <a href="javascript:if(confirm('Anda yakin ingin menghapus data<?php echo $tag; ?>?'))window.location.href='tag-mode-hapus-data-<?php echo $id_tag;?>_notif-hapusberhasil'" 
...
if($jum_halaman==0){
   ...
   $setelah = $halaman+1;
   if($halaman!=1){
     echo "<li class='page-item'><a class='page-link' href='tag-halaman-1'>First</a></li>";
     echo "<li class='page-item'><a class='page-link' href='tag-halaman-$sebelum'>«</a></li>";
  }
  for($i=1; $i<=$jum_halaman; $i++){
      if ($i > $halaman - 5 and $i < $halaman + 5 ) {
         if($i!=$halaman){
             echo "<li class='page-item'><a class='page-link'href='tag-halaman-$i'>$i</a></li>";
         }else{
   ...
   if($halaman!=$jum_halaman){
        echo "<li class='page-item'><a class='page-link' href='tag-halaman-$setelah'>»</a></li>";
        echo "<li class='page-item'><a class='page-link' href='tag-halaman-$jum_halaman'>Last</a></li>";
   }
