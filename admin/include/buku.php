                  ...
                  <table class="table table-bordered">
                    ...
                    <?php 
                      ...
                      <tr>
                        ...
                        <td align="center">
                          <a href="edit-buku-data-<?php echo $id_buku;?>" class="btn btn-xs btn-info" title="Edit"><i class="fas fa-edit"></i></a>
                          <a href="detail-buku-data-<?php echo $id_buku;?>"class="btn btn-xs btn-info" title="Detail"><i class="fas fa-eye"></i></a>
                          <a href="javascript:if(confirm('Anda yakin ingin menghapus data <?php echo $judul; ?>?')) window.location.href = 'buku-mode-hapus-data-<?php echo $id_buku;?>_notif-hapusberhasil'"
...
if($jum_halaman==0){
   ...
   $setelah = $halaman+1;
   if($halaman!=1){
     echo "<li class='page-item'><a class='page-link' href='buku-halaman-1'>First</a></li>";
     echo "<li class='page-item'><a class='page-link' href='buku-halaman-$sebelum'>«</a></li>";
  }
  for($i=1; $i<=$jum_halaman; $i++){
      if ($i > $halaman - 5 and $i < $halaman + 5 ) {
         if($i!=$halaman){
             echo "<li class='page-item'><a class='page-link'href='buku-halaman-$i'>$i</a></li>";
         }else{
   ...
   if($halaman!=$jum_halaman){
        echo "<li class='page-item'><a class='page-link' href='buku-halaman-$setelah'>»</a></li>";
        echo "<li class='page-item'><a class='page-link' href='buku-halaman-$jum_halaman'>Last</a></li>";
   }
