        ...
        <tbody>
          ...
          <tr>
            ...
            <td align="center">
              ...
              <a href="javascript:if(confirm('Anda yakin ingin menghapus data <?php echo $kategori_buku; ?>?'))window.location.href ='kategori-buku-mode-hapus-data-<?php echo $id_kategori_buku;?>_notif-hapusberhasil'" class="btn btn-xs btn-warning"><i class="fas fa-trash"></i>  
                      Hapus
                      </a>
            </td>
...
if($jum_halaman==0){
   ...
   $setelah = $halaman+1;
   if($halaman!=1){
     echo "<li class='page-item'><a class='page-link' href='kategori-buku-halaman-1'>First</a></li>";
     echo "<li class='page-item'><a class='page-link' href='kategori-buku-halaman-$sebelum'>«</a></li>";
  }
  for($i=1; $i<=$jum_halaman; $i++){
      if ($i > $halaman - 5 and $i < $halaman + 5 ) {
         if($i!=$halaman){
             echo "<li class='page-item'><a class='page-link'href='kategori-buku-halaman-$i'>$i</a></li>";
         }else{
   ...
   if($halaman!=$jum_halaman){
        echo "<li class='page-item'><a class='page-link' href='kategori-buku-halaman-$setelah'>»</a></li>";
        echo "<li class='page-item'><a class='page-link' href='kategori-buku-halaman-$jum_halaman'>Last</a></li>";
   }
