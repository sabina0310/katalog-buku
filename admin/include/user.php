              ...
              <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td align="center">
                          ...
                          <a href="javascript:if(confirm('Anda yakin ingin menghapus data <?php echo $nama; ?>?'))window.location.href = 'user-mode-hapus-data-<?php echo $id_user;?>_notif-hapusberhasil'" 
